			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-sm-6 col-md-4 my-4">
						<a href="<?php echo e(route('login')); ?>" class="btn text-white bg-nav w-100"><h2><i class="fas fa-graduation-cap"></i> Aluno</h2></a>
					</div>
					<div class="col-sm-6 col-md-4 my-4">
						<a href="<?php echo e(route('professor.login')); ?>" class="btn text-white bg-nav w-100"><h2><i class="fas fa-chalkboard-teacher"></i> Professor</h2></a>
					</div>
					<div class="col-sm-6 col-md-4 my-4">
						<a href="<?php echo e(route('admin.login')); ?>" class="btn text-white bg-nav w-100"><h2><i class="fas fa-user-cog"></i> Administração</h2></a>
					</div>
				</div>
