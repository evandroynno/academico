...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-md-10">
			<form action="<?php echo e(route('admin.alunosMateria')); ?>" method="POST" >
				<?php echo csrf_field(); ?>
				<card titulo='Selecione a Disciplina' cor="bg-nav" submit="Próximo" voltar="<?php echo e(route('admin.home')); ?>">
