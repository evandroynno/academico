		...
		<div class="col-12">
			<div class="card bg-nav">
 						...
 						<table class="table table-hover">
							...
							<?php $__empty_1 = true; $__currentLoopData = $solicitacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<tr>
									...
									<td class="text-nowrap">
										<button class="btn btn-primary mb-2" data-toggle="modal" data-target="#modal" data-solicitacao=<?php echo e($solicitacao->id); ?>>Responder</button>
										<a href="<?php echo e(route('admin.encerrarSolicitacao', ['idSolicitacao' => $solicitacao->id])); ?>" class="btn btn-secondary text-white mb-2" onclick="return confirm('Encerrar Solicitação?')">Encerrar</a>
									</td>
								</tr>
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-md-6 offset-md-4"><a href="<?php echo e(route('admin.home')); ?>" class="btn btn-primary"> <i class="fas fa-arrow-circle-left"></i> Voltar</a></div>
					</div>
				</div>
			</div>
			<div class="modal fade" id="modal" tabindex="1" role="dialog" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content bg-nav">
						<form action="<?php echo e(route('admin.responderSolicitacao')); ?>" method="POST">
							<?php echo csrf_field(); ?>
